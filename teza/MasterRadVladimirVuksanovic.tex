...
Ovaj problem se susreće prilikom optimizacije izdvajanje koda u kompajleru LLVM.
...
Smanjenje ukupnog broja instrukcija u programu onemogućava skladištenje lokacija na redovan način zato što bi jednoj instrukciji odgovaralo više različitih lokacija, a to trenutno nije podržano.
...
Takođe su detaljno opisane faze kompilacije u okviru kompajlera LLVM za koje će biti implementirano rešenje.
...
Poglavlje \ref{sec:outlining} uvodi optimizaciju izdvajanja koda, opisuje njene implementacije u kompajleru LLVM i predstavlja problem koji je tema ovog rada.
...
Kako računar još uvek razumeju samo mašinski k\^od, nastali su posebni alati, asembleri, koji vrše jednostavne zamene mnemonika i operanada sa odgovarajućim mašinskim kodom.
...
Poslednja dva zadatka nisu neophodna, ali ih svaki dobar kompajler radi.
...
Svaki dobar kompajler ga ipak sadrži, i on je možda čak najveći deo kompajlera.
...
\begin{biografija}
  ...
  Tamo radi na sistemskom softveru, primarno na projektima vezanim za infrastrukturu LLVM.
\end{biografija}
% ------------------------------------------------------------------------------
