...
% Kompilatori često imaju više opcija za optimizaciju sa različitim odnosima ova dva cilja.
...
\begin{listing}[!ht]
\begin{minted}[fontsize=\small,breaklines,xleftmargin=20pt,linenos,tabsize=4]{c}
#include <stdio.h>
...
\begin{listing}[!ht]
\begin{minted}[fontsize=\footnotesize,breaklines,xleftmargin=20pt,linenos]{llvm}
...
\begin{description}
  ...
  \item[Izvršavanje korak po korak] --- Ovo predstavlja najčešći i najjednostavniji vid kretanja kroz program. Omogućava kontrolisano izvršavanje samo određenog dela koda. Korak može da označava jednu instrukciju, jedan red ili jednu funkciju. % TODO expand
...
\begin{listing}[!ht]
% \begin{minted}[xleftmargin=20pt, linenos, tabsize=4, fontsize=\footnotesize, breaklines]{asm}
% main:                                   # @main
% .Lfunc_begin1:
...
\begin{minted}[xleftmargin=20pt, linenos, tabsize=4, fontsize=\footnotesize, breaklines]{llvm}
; ModuleID = 'outline.ll'
...
Radi lakšeg budućeg pristupa, grupiše ih po njihovom drugom argumentu koji predstavlja metapodatak \verb|outline_id| instrukcije poziva. % (DbgOutlinedInstrMap DbgOutlines)
